...
class CartController extends AbstractController
{
    ...
    public function order(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            Stripe::setApiKey('sk_test_51KrL9ZADV5UQjkwhYDbP3XrJfJIXhc7UTbXHrEhylPRCcezaDxk9z1h5sId8xgyoHwllcoY5y7orrn7rM4dFqjJa00YTNVvFbn');
    ...
    #[Route('/commande/{id}/confirmation', name: 'app_frontend_cart_success')]
    #[IsGranted('ROLE_USER')]
    ...
    #[Route('/commande/{id}/erreur', name: 'app_frontend_cart_error')]
    #[IsGranted('ROLE_USER')]
